...
describe('Model', function () {
    ...
    describe('native mongo methods', function() {
        ...
        it('should have a runNativeMongo medthod for making calls to Mongo', function() {
            ...
            return waterline.testobjects.runNativeMongo('findAndModify', [query, {}, update, options])
            .then(function() {
        ...
        it('should have a findMongo method that calls the runNativeMongo method', function() {
            ...
            .then(function() {
                ...
                expect(waterline.testobjects.runNativeMongo).to.have.been.calledWith('find', [query]);
            });
        });

        it('should have a findAndModifyMongo method that calls the runNativeMongo method', function() {
        ...
        it('should have a createMongoIndexes method that calls the runNativeMongo method', function() {
