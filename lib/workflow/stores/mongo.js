...
function mongoStoreFactory(waterline, Promise, Constants, Errors, assert, _) {
    ...
    exports.findCompletedTasks = function() {
        var query = {
            $or: [
                {
                    evaluated: true,
        ...
        return waterline.taskdependencies.findMongo(query);
    };

    exports.deleteTasks = function(taskIds) {
        assert.arrayOfString(taskIds, "mongo store deleteTasks task ids");
